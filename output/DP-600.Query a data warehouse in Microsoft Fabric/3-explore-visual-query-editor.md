...
![Animated GIF showing how to build a query using the visual query editor for a data warehouse in Microsoft Fabric.](../../wwl-data-ai/query-data-warehouse-microsoft-fabric/media/3-visual-editor.gif)
...
To learn more about SQL query editor, see [Query using the visual query editor](/en-us/fabric/data-warehouse/visual-query-editor?azure-portal=true).
