...
![Screenshot of the Fabric UI with an arrow pointing to the create hub.](../../wwl/get-started-data-warehouse/media/create-data-warehouse.png)
...
You can copy data from an external location into a table in the data warehouse using the syntax. For example:
...
![Screenshot of the SQL query editor with a query open.](../../wwl/get-started-data-warehouse/media/create-table-manual.png)
...
Working with tables in the Fabric data warehouse currently has some limitations. See [Tables in data warehousing in Microsoft Fabric](/en-us/fabric/data-warehouse/tables) for more information.
